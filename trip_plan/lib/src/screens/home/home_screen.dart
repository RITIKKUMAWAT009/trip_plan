                                ...
                                controller: controller,
                                  ...
                                  itemBuilder: (context,index){
                                    return GestureDetector(
                                      onTap:()=> Get.to(()=>const DestinationDetails()),
                                      child: Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              Column(
                                                crossAxisAlignment: CrossAxisAlignment.start,
                                                children: [
                                                  const Text("Shimla Manali Tour",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                                                  const Row(
                                                    children: [
                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      const Text(" (29)",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 15),)
                                                    ],
                                                  ),
                                                ],
                                              ),
